    ...
    <div className="flex flex-col items-center">
      ...
      {isVerifying && (
        <motion.div 
          initial={{ opacity: 0 }} 
          animate={{ opacity: 1 }} 
          className="mt-6 flex items-center gap-2 text-indigo-600 dark:text-indigo-400 font-medium"
        >
    ...
    return (
      <div className="p-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
        <div className="mb-10 text-center">
          <div className="w-16 h-16 bg-indigo-50 dark:bg-indigo-950/30 rounded-full flex items-center justify-center mx-auto mb-6 shadow-inner">
        ...
        <div className="mt-10 space-y-4">
          ...
          <button 
            onClick={() => router.back()}
            className="w-full flex items-center justify-center gap-2 text-slate-400 dark:text-slate-500 hover:text-slate-655 dark:hover:text-slate-300 transition-colors text-sm font-semibold cursor-pointer"
          >
            <ArrowLeft size={16} />
