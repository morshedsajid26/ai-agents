          ...
          <div className="max-h-60 overflow-y-auto hide-scrollbar">
            {options.map((item, index) => (
              <div
                ...
                className={`py-2.5 px-4 hover:bg-indigo-50 hover:text-indigo-600 dark:hover:bg-slate-800 dark:hover:text-indigo-400 cursor-pointer transition-colors text-sm ${selected === item ? 'bg-indigo-50 text-indigo-600 dark:bg-slate-800 dark:text-indigo-400 font-semibold' : ''}`}
              >
                {item}
              </div>
            ))}
